...
public class BaseUtils {
	...
	private BaseUtils(){	
        ...
        // con notificacion
		AUTHENTICATION_RESPONSE_TABLE.put("100000000000", 0);
		AUTHENTICATION_RESPONSE_TABLE.put("01-1010-2020", 0);
		AUTHENTICATION_RESPONSE_TABLE.put("01-2020-3030", 0);
		AUTHENTICATION_RESPONSE_TABLE.put("01-4040-5050", 0);
		AUTHENTICATION_RESPONSE_TABLE.put("01-6060-7070", 0);
		AUTHENTICATION_RESPONSE_TABLE.put("01-8080-9090", 0);
		AUTHENTICATION_RESPONSE_TABLE.put("01-1100-2211", 0);
		AUTHENTICATION_RESPONSE_TABLE.put("01-3344-5566", 0);
		AUTHENTICATION_RESPONSE_TABLE.put("01-7788-9900", 0);
	    ...
	    // Con notificación
		DOCUMENT_RESPONSE_TABLE.put("100000000000", 0);
		DOCUMENT_RESPONSE_TABLE.put("01-1010-2020", 0);
		DOCUMENT_RESPONSE_TABLE.put("01-2020-3030", 0);
		DOCUMENT_RESPONSE_TABLE.put("01-4040-5050", 0);
		DOCUMENT_RESPONSE_TABLE.put("01-6060-7070", 0);
		DOCUMENT_RESPONSE_TABLE.put("01-8080-9090", 0);
		DOCUMENT_RESPONSE_TABLE.put("01-1100-2211", 0);
		DOCUMENT_RESPONSE_TABLE.put("01-3344-5566", 0);
		DOCUMENT_RESPONSE_TABLE.put("01-7788-9900", 0);
